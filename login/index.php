...
<html lang="en">
  ...
  <body id="home">
    ...
    <!--Navbar-->
    <nav class="navbar navbar-expand-lg navbar-light primary shadow navbar fixed-top bg-transparent">
      <div class="container">
    ...
    <marquee behavior="" direction=""> <h3 style="color : black; font-style: italic;">Hey Welcome!</h3></marquee>
      <h1 class="display-4">KEMAL EL FARAOUK</h1>
      <h2 class="display-4">1955201079</h2>
      <h2 class="display-4">KRIPTOGRAFI 7.3</h2>
